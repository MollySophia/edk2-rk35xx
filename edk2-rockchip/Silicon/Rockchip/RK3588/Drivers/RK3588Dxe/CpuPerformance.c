  ...
  )
{
  ...
  UINT32 CPUClusterClockPreset[] = { PcdGet32 (PcdCPULClusterClockPreset),
  ...
  )
{
  ...
  SCMI_OPP_TABLE  ScmiOppTable;
  UINT32          Microvolts;
  UINT32 CPUClusterVoltageMode[] = { PcdGet32 (PcdCPULClusterVoltageMode),
                                     PcdGet32 (PcdCPUB01ClusterVoltageMode),
                                     PcdGet32 (PcdCPUB23ClusterVoltageMode) };
  UINT32 CPUClusterVoltageCustom[] = { PcdGet32 (PcdCPULClusterVoltageCustom),
  ...
  )
{
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPULClusterClockPreset",
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPULClusterClockCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB01ClusterClockPreset",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB01ClusterClockCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB23ClusterClockPreset",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB23ClusterClockCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPULClusterVoltageMode",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPULClusterVoltageCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB01ClusterVoltageMode",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB01ClusterVoltageCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB23ClusterVoltageMode",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
  ...
  Size = sizeof (UINT32);
  Status = gRT->GetVariable (L"CpuPerf_CPUB23ClusterVoltageCustom",
                            &gRK3588DxeFormSetGuid,
                            NULL, &Size, &Var32);
  if (EFI_ERROR (Status)) {
