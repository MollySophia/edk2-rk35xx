...
[PcdsFixedAtBuild.common]
  ...
  gRockchipTokenSpaceGuid.PcdPlatformName|"Kulun"
  gRockchipTokenSpaceGuid.PcdPlatformVendorName|"Lenovo"
  gRockchipTokenSpaceGuid.PcdFamilyName|"Kulun"
  gRockchipTokenSpaceGuid.PcdProductUrl|""

  # I2C
  gRockchipTokenSpaceGuid.PcdI2cSlaveAddresses|{ 0x2c }
  gRockchipTokenSpaceGuid.PcdI2cSlaveBuses|{ 0x4 }
